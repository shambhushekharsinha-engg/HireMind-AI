...
INDUSTRY_FIELDS_TAXONOMY = {
    "software_engineering": {
        ...
        "core_skills": ["Python", "Java", "C++", "C#", "Go", "Rust", "System Design", "Microservices", "REST API", "GraphQL", "Data Structures", "Algorithms", "Git"],
        "benchmark_ats_weight": 0.35
    },
    "data_science_ai": {
        "domain_name": "Data Science, Machine Learning & AI",
        "core_skills": ["Python", "PyTorch", "TensorFlow", "Scikit-Learn", "Pandas", "NumPy", "NLP", "Computer Vision", "LLMs", "RAG", "SQL", "Spark", "MLOps"],
        "benchmark_ats_weight": 0.40
    },
    "cloud_devops": {
        "domain_name": "Cloud Engineering, DevOps & SRE",
        "core_skills": ["AWS", "Azure", "GCP", "Docker", "Kubernetes", "Terraform", "Ansible", "CI/CD", "Linux", "Bash", "Prometheus", "Grafana", "Networking"],
        "benchmark_ats_weight": 0.38
    },
    "cybersecurity": {
        "domain_name": "Cybersecurity & InfoSec",
        "core_skills": ["Penetration Testing", "Ethical Hacking", "SIEM", "Wireshark", "Network Security", "Cryptography", "SOC", "OWASP", "Firewalls", "Incident Response"],
        "benchmark_ats_weight": 0.36
    },
    "mobile_development": {
        "domain_name": "Mobile Application Engineering",
        "core_skills": ["React Native", "Flutter", "Swift", "Kotlin", "Android SDK", "iOS Development", "Mobile UI/UX", "SQLite", "Firebase", "App Store Deployment"],
        "benchmark_ats_weight": 0.35
    },
    "fintech_hft": {
        "domain_name": "Quantitative Finance & High-Frequency Trading",
        "core_skills": ["C++", "Python", "Quantitative Modeling", "Low-Latency Systems", "Financial Engineering", "SQL", "Risk Analysis", "Multithreading", "Order Execution"],
        "benchmark_ats_weight": 0.42
    },
    "product_management": {
        "domain_name": "Technical Product Management & Analytics",
        "core_skills": ["Product Roadmap", "Agile/Scrum", "User Stories", "A/B Testing", "Mixpanel", "Jira", "SQL", "Product Analytics", "Market Research", "Stakeholder Management"],
