    ...
    def extract_candidate_name(text: str) -> str:
            ...
            try:
                ...
                for ent in doc.ents:
                    if ent.label_ == "PERSON":
                        ...
                        if 2 <= len(words) <= 4 and not re.search(
                            r"(engineer|developer|manager|designer|architect|resume|cv|summary|experience)",
                            clean_name,
                            re.I,
                        ):
        ...
        for line in lines[:5]:
            ...
            if (
                ...
                or "http" in line_lower
                or "linkedin" in line_lower
            ):
                continue
