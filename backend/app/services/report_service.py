...
class ReportService:
    ...
    def generate_pdf_report(cls, analysis_data: Dict[str, Any], filename_prefix: str = "HireMind_Analysis") -> str:
        ...
        story.append(Paragraph("<i>Generated by HireMind AI — AI-Powered Career Intelligence Platform</i>", ParagraphStyle("Footer", parent=body_style, fontSize=8, textColor=colors.gray)))
