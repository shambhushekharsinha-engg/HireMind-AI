...
def test_login_invalid_credentials():
    res = client.post("/api/v1/auth/login", json={"email": "nonexistent@hiremind.ai", "password": "WrongPassword"})
...
def test_otp_generation_and_verification():
    ...
    verify_req = client.post("/api/v1/auth/verify-otp", json={"email": "otpuser@hiremind.ai", "otp_code": "123456"})
