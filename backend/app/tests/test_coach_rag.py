from app.services.career_coach import AnswerValidator, RAGPromptBuilder, career_coach_service
...
def test_rag_prompt_builder_and_validator():
    ...
    validation = AnswerValidator.validate(
        "To optimize ATS, use clean formatting and relevant keywords.", "How to optimize ATS?"
    )
