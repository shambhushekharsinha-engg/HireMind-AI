...
async def upload_and_analyze_resume(
    ...
    if not db_resume:
        db_resume = resume_repository.create(db, {
            "user_id": user_id,
            "title": "Main Resume",
    ...
    audit_service.log_event("RESUME_UPLOAD", user_id=user_id, details={"filename": file.filename, "ats_score": eval_result["ats_score"]})
    background_tasks.add_task(async_task_processor.generate_pdf_report, db_resume.id, {"ats_score": eval_result["ats_score"]})
